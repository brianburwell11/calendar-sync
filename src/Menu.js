...
var MAPPING_HEADER_NOTES = {
  ...
  14: 'optional: event color. A color name or 1-11. Blank = the destination calendar\'s default color. full/busy: colors the copy. invite: colors your own copy on the destination, only for events this mapping invited and only if you can edit that calendar.',
